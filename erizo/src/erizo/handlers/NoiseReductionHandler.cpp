...
namespace erizo {
    ...
    NoiseReductionHandler::NoiseReductionHandler(std::map <std::string,std::string>  parameters): parameters{parameters}{
        ...
        float reduction = pow(10, - std::stoi(parameters.at("reduction"),nullptr,10)/10); //Atenunation to db
